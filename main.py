    ...
    def get_late_books(self, l_borrower_id=0):
        ...
        for row in range(len(list_books)):
            if list_books[row].borrow_date + datetime.timedelta(days=30) < datetime.date.today():
                print(list_books[row].book_id, '  ', list_books[row].book_name, ' ', list_books[row].late_fee)
                payment += list_books[row].late_fee
        if payment == 0:
            print(Fore.WHITE + title_format.format(title='No book is late return'))
        else:
            print(Fore.WHITE + title_format.format(title='Total payment is: ' + str(payment) + '$'))
...
def librarian_menu():
    ...
    print('Press 6 to see all the book available')
...
while user_input != 0:
    if user_input == 1:
        ...
        if login_borrower.id > 0:
            ...
            login_borrower.print_empty_line(2)
            ...
            login_borrower.print_empty_line(2)
            print(title_format.format(title='Your total payment until {} is {}$'.format(datetime.date.today(), login_borrower.payment)))
            login_borrower.print_empty_line(4)
        ...
        # Login user as an librarian account
            ...
            login_librarian.print_empty_line(4)
